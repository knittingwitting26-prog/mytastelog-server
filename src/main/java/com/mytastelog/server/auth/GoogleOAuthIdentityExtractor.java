...
@Component
public class GoogleOAuthIdentityExtractor implements OAuthIdentityExtractor {
	@Override
	...
	public OAuthIdentity extract(OAuth2AuthenticationToken authentication) {
		...
		if (subject == null || subject.isBlank()) {
			throw new OAuth2AuthenticationException(
				new OAuth2Error("invalid_authentication_response"), "Google subject is missing");
		}
		return new OAuthIdentity(AuthProvider.GOOGLE, subject);
	}
}
